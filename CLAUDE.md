...
- **`docs/vm-performance.md` is its speed**: the instruments (`tools/run_vm_bench.py`,
  ...
  measured, and the ranked list of what to change. After §4's rows 1, 2, 3 and 5 it runs Verse
  faster than the UE host on all fifteen workloads, and entering it costs a fifth as much. The
